...
class SimpleQASystem2:
    def __init__(self):
        ...
        self.embedding_path = os.path.join(cur, 'embedding\\zhwiki_20180420_100d.txt')
    ...
    def answer_question(self, question):
        ...
        if answer_dict:
            ...
            final_answer = '您好,对于此类问题,您可以咨询公安部门++++llm'
        #
    ...
    # def answer_question(self, question):
    #     return  '您好,对于此类问题,您可以咨询公安部门'

if __name__ == "__main__":
    handler = SimpleQASystem2()
    while(1):
        question = input('question:')
        final_answer = handler.answer_question(question)
